...
class CredisSentinelTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testMasterClient()
  {
      ...
      $this->expectExceptionMessage('Master not found');
  ...
  public function testMaster()
  {
      ...
      $this->expectException(CredisException::class);
      $this->expectExceptionMessage('No such master with that name');
  ...
  public function testCreateCluster()
  {
      ...
      $this->assertCount(2,$cluster->clients());
      $this->expectException(CredisException::class);
      $this->expectExceptionMessage('The master is down');
  ...
  {
      $this->expectException(CredisException::class);
      $this->expectExceptionMessage('Unknown sentinel subcommand \'bla\'');
      $this->sentinel->bla();
  }
}
